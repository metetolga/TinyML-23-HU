...
from utils import ToTensor, CustomDataset, F1, FB, Sensitivity, Specificity, BAC, ACC, PPV, NPV
...
def main():
    ...
    net = torch.load(path_net + 'net.pkl')
    net.eval()
    net.cuda()
    ...
    for subject_id in subjects:
        testset = CustomDataset(root_dir=path_data,
...
if __name__ == '__main__':
    ...
    print(f"data path: {args.path_data}")
